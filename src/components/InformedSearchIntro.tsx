...
import './Section.css'
import HeuristicTreeViz from './shared/HeuristicTreeViz'
  ...
  return (
    <div className="section">
      ...
      <div className="content-card">
        ...
        {/* 다이어그램 */}
        <div style={{ background: '#f8f9fa', borderRadius: 8, padding: '1.5rem', display: 'flex', justifyContent: 'center' }}>
          <svg viewBox="0 0 800 280" style={{ width: '100%', maxWidth: 800 }}>
            {/* 비정보이용 - 레벨별 모든 노드 탐색 트리 */}
            <text x="200" y="18" textAnchor="middle" fontSize="14" fill="#c2185b" fontWeight="bold">비정보이용 탐색</text>
            {/* 루트 */}
            <circle cx="200" cy="55" r="16" fill="#e91e63" />
            <text x="200" y="60" textAnchor="middle" fontSize="12" fill="white">S</text>
            {/* 레벨 1: 4개 노드 */}
            {[110, 165, 235, 290].map((x, i) => (
              <g key={i}>
                <line x1="200" y1="71" x2={x} y2="116" stroke="#e91e63" strokeWidth="1.5" strokeDasharray="4,2" />
                <circle cx={x} cy="128" r="13" fill="#f48fb1" />
                <text x={x} y="133" textAnchor="middle" fontSize="10" fill="white">{i + 1}</text>
              </g>
            ))}
            {/* 레벨 2: 일부 노드 */}
            {[88, 132, 178, 218, 258, 298].map((x, i) => (
              <g key={i}>
                <line x1={[110, 110, 165, 235, 290, 290][i]} y1="141" x2={x} y2="176" stroke="#e91e63" strokeWidth="1" strokeDasharray="3,2" opacity="0.7" />
                <circle cx={x} cy="185" r="10" fill="#f8bbd0" />
              </g>
            ))}
            <circle cx="200" cy="248" r="14" fill="#880e4f" />
            <text x="200" y="253" textAnchor="middle" fontSize="11" fill="white">G</text>
            <text x="200" y="272" textAnchor="middle" fontSize="11" fill="#888">레벨별 모든 노드 탐색</text>

            {/* 구분선 */}
            <line x1="400" y1="20" x2="400" y2="270" stroke="#ccc" strokeWidth="1" strokeDasharray="4,4" />

            {/* 정보이용 - 목표 방향 집중 트리 */}
            <text x="600" y="18" textAnchor="middle" fontSize="14" fill="#2e7d32" fontWeight="bold">정보이용 탐색</text>
            {/* 루트 */}
            <circle cx="600" cy="55" r="16" fill="#4caf50" />
            <text x="600" y="60" textAnchor="middle" fontSize="12" fill="white">S</text>
            {/* h값 낮은 방향 우선 */}
            <line x1="600" y1="71" x2="560" y2="116" stroke="#4caf50" strokeWidth="2.5" />
            <circle cx="560" cy="128" r="13" fill="#81c784" />
            <text x="560" y="133" textAnchor="middle" fontSize="10" fill="white">h=2</text>
            {/* 비선택 노드 (흐리게) */}
            <line x1="600" y1="71" x2="640" y2="116" stroke="#a5d6a7" strokeWidth="1" strokeDasharray="3,2" opacity="0.5" />
            <circle cx="640" cy="128" r="13" fill="#c8e6c9" opacity="0.6" />
            <text x="640" y="133" textAnchor="middle" fontSize="10" fill="#888">h=8</text>
            {/* 다음 레벨 */}
            <line x1="560" y1="141" x2="560" y2="176" stroke="#4caf50" strokeWidth="2.5" />
            <circle cx="560" cy="188" r="13" fill="#388e3c" />
            <text x="560" y="193" textAnchor="middle" fontSize="10" fill="white">h=1</text>
            {/* 목표 */}
            <line x1="560" y1="201" x2="600" y2="234" stroke="#4caf50" strokeWidth="3" markerEnd="url(#arrow2)" />
            <circle cx="600" cy="248" r="14" fill="#1b5e20" />
            <text x="600" y="253" textAnchor="middle" fontSize="11" fill="white">G</text>
            <text x="600" y="272" textAnchor="middle" fontSize="11" fill="#888">h(n) 낮은 방향 우선</text>
            <defs>
